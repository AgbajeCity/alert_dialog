...
3.  **`actions`**: (Type: `List<Widget>`) Defines the list of buttons (or other widgets) at the bottom of the dialog, which allow the user to respond and close it.

---

## Screenshot of the AlertDialog demo app in action
<img width="1439" height="749" alt="Screenshot 2025-11-11 at 19 59 17" src="https://github.com/user-attachments/assets/4bb6f3a8-b600-426d-91ee-6d86bfa81588" />
